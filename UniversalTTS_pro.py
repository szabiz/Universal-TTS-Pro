...
class App:
    ...
    def show_about(self):
        ...
        about_text = (
            ...
            "  - en_US LibriTTS-R: CC BY 4.0\n"
            "    \"LibriTTS-R: A Restored Multi-Speaker Text-to-Speech Corpus\"\n"
            "    by Yuma Koizumi, Heiga Zen, Shigeki Karita,\n"
            "    Yifan Ding, Kohei Yatabe, Nobuyuki Morioka,\n"
            "    Michiel Bacchiani, Yu Zhang, Wei Han,\n"
            "    and Ankur Bapna\n"
            "    Source: OpenSLR SLR141\n"
            "  - Piper Voices repository: MIT License\n"
            "    Source: rhasspy/piper-voices (Hugging Face)\n\n"
            "• Piper TTS (Voice Engine):\n"
            "  by Michael Hansen / Rhasspy — MIT License\n\n"
            "• Sherpa-ONNX Runtime (Piper):\n"
            "  by k2-fsa / Next-gen Kaldi — Apache License 2.0\n\n"
            "• Phonetic Processing: eSpeak NG Data & Rules\n"
            "  by eSpeak NG contributors — GNU GPL v3.0 or later\n\n"
            "• Voice Engine (Supertonic): Supertonic TTS 3\n"
            "  by Supertone Inc. — MIT (Code) / OpenRAIL-M (Weights)\n\n"
            "• Audio Playback: SoundDevice\n"
            "  by Matthias Geier — MIT License\n"
            "  PortAudio by Ross Bencina & Phil Burk — MIT License\n\n"
            "• Numerical Processing: NumPy\n"
            "  NumPy Contributors — BSD 3-Clause License\n\n"
            "• Audio Compression: Opus Tools (opusenc)\n"
            "  by Xiph.Org Foundation — BSD 3-Clause License\n\n"
            "• GUI Framework: Python / Tkinter\n"
            "  by Python Software Foundation — PSF License\n\n"
            ...
            "  Supertone Inc., eSpeak NG, Xiph.Org,\n"
            "  Python Software Foundation, NumPy contributors,\n"
